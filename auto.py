...
def sent_report(cookies):
    ...
    params = {
        ...
        "city":"西安市",
        "province":"陕西省",
        "address":"陕西省西安市莲湖区西关街道怀德巷西北大学桃园校区",
        "geo_api_info":'{"type":"complete","info":"SUCCESS","status":1,"$Da":"jsonp_687452_","message":"Get ipLocation success.Get address success.","location_type":"ip","accuracy":null,"isConverted":true,"addressComponent":{"citycode":"029","adcode":"610104","businessAreas":[],"neighborhoodType":"","neighborhood":"","building":"","buildingType":"","street":"高新四路","streetNumber":"145号","country":"中国","province":"陕西省","city":"西安市","district":"莲湖区","towncode":"610104006000","township":"西关街道"},"formattedAddress":"陕西省西安市莲湖区西关街道怀德巷西北大学桃园校区","roads":[],"crosses":[],"pois":[]}',   #高德SDK返回值
        "sfcyglq":"0",  #是否隔离期
        "sfyzz":"0",    #是否有症状
        "qtqk":"",  #其他情况
        "ymtys":""  #不明（可能是一码通颜色，暂无用）
